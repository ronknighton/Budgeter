...
namespace Budgeter.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    if(returnUrl == null && usersHelper.IsHOH(model.Email))
                    {
        ...
        [AllowAnonymous]
        public ActionResult AddUserToHousehold(string email, int hId, string backto)
        {
            ViewBag.Email = email;
            ViewBag.hId = hId;
            ViewBag.BackTo = backto;
            ViewBag.Household = "You will be added to the household after you register.";
        ...
        {           
            ...
            TempData["ManualAddMember"] = "Manually Added Member";
            return View("Register");
        }
